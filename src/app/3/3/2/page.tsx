...
export default function Page() {
  return (
    <>
      <EndCard
        prompt={[
          `You open your mouth, not know what will come out.`,
          `Beautiful sound fills your ears, each note, each harmony swells your heart with joy 
      ...
      on his gull. "Thank you, my friend. I never thought I'd experience beauty like that again 
